...
export const MessageRoom = () => {
    ...
    const attachString = useSelector((state: RootType) => state.sideBarTextState.sideBarText)
    //-----------------------------------------------------------------------------//
...
///------------------------------------------------START of useEffect Codes------------------------------------------------------------//
    ...
    useEffect(() => {
        if(attachOpen) setIsAttachmentopen(false)
...
///------------------------------------------------END of Websocket connection made live------------------------------------------------------------//
    ...
    {/* START */}
        ...
        <div className={`absolute inset-0 flex justify-center items-center bg-black bg-opacity-40 
            ${(attachOpen && (attachString === 'uploadImage' || attachString === 'uploadVideo' || attachString === 'uploadDocument')) 
            ?  "visble" : "hidden"} overflow-y-hidden overflow-x-auto`}>
            <Upload></Upload>
        </div>
